...
var QUESTION = {
  ...
  options:   [
    ...
    {
      "text": "2",
      "description": "Not Alert; requires repeated stimulation to attend, or is obtunded and requires strong or painful.",
      "correct": false,
      "rationale": ""
    },
    {
...
function showQuestion() {
  ...
  questionNumber.textContent = 'Item 1a: Level of Consciousness';
