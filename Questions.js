...
export const QUESTIONS_DATA = [
  {
    ...
    "options": [
      ...
      { "text": "2", "description": "Not Alert; requires repeated stimulation to attend, or is obtunded and requires strong or painful.", "feedback": "", "rationale": "", "correct": false },
      { "text": "3", "description": "Responds only with reflex motor or autonomic effects, or totally unresponsive, flaccid, and areflexic.", "feedback": "", "rationale": "", "correct": false }
    ]
  },
  {
    "id": "Q2",
  ...
  },
  {
    ...
    "options": [
      ...
      { "text": "1", "description": "Partial gaze palsy; gaze is abnormal in one or both eyes, but forced deviation or total gaze paresis is not present.", "feedback": "", "rationale": "", "correct": false },
  ...
  },
  {
    ...
    "options": [
      ...
      { "text": "3", "description": "Bilaterial hemianopia (blind including cortical blindness)", "feedback": "", "rationale": "", "correct": false }
    ]
  },
  {
    "id": "Q6",
    ...
    "options": [
      ...
      { "text": "3", "description": "Complete paralysis of one or both sides (absences of facial movement in the upper and lower face).", "feedback": "", "rationale": "", "correct": false }
    ]
  },
  {
    "id": "Q7",
    ...
    "chainTo": "Q8",
    "options": [
      { "text": "0", "description": "No drift; limb holds 90 (or 45) degrees for full 10 seconds.", "feedback": "", "rationale": "<PASTE RATIONALE HERE>", "correct": false },
      { "text": "1", "description": "Drift; limb holds 90 (or 45) degrees, but drifts down before full 10 seconds; does not hit bed or other support.", "feedback": "", "rationale": "", "correct": true },
      { "text": "2", "description": "Some effort against gravity; limb cannot get to or maintain (if cued) 90 (or 45) degrees, drifts down to bed, but has some effort against gravity.", "feedback": "", "rationale": "", "correct": false },
  ...
  },
  {
    ...
    "chainTo": "Q10",
    "options": [
      { "text": "0", "description": "No drift; leg holds 30-degree position for full 5 seconds.", "feedback": "", "rationale": "<PASTE RATIONALE HERE>", "correct": false },
      { "text": "1", "description": "Drift; leg falls by the end of the 5-second period but does not hit the bed.", "feedback": "", "rationale": "", "correct": true },
  ...
  },
  {
    ...
    "options": [
      ...
      { "text": "1", "description": "Present in one limb", "feedback": "", "rationale": "", "correct": false },
      { "text": "2", "description": "Present in two limbs", "feedback": "", "rationale": "", "correct": false },
      { "text": "UN", "description": "Amputation or joint fusion", "feedback": "", "rationale": "", "correct": false }
    ]
  },
  {
    ...
    "options": [
      ...
      { "text": "1", "description": "Mild-to-moderate sensory loss; patient feels pinprick is less sharp or is dull on the affected side; or there is a loss of superficial pain with pinprick, but the patient is aware of being touched.", "feedback": "", "rationale": "", "correct": false },
  ...
  },
  {
    ...
    "options": [
      ...
      { "text": "1", "description": "Mild-to-moderate aphasia; some obviousl loss of fluency or facility to comprehension, without signifant limitation on ideas expressed or form of expression. Reduction of speech and/or comprehension, however, makes conversation about provided materials difficult or impossible. For example, in conversation about provided materials, examiner can identify picture or naming card content from patient's response.", "feedback": "", "rationale": "", "correct": false },
      { "text": "2", "description": "Severe aphasia; all communication is through fragmentary expression; great need for inference, questioning, and guessing by the listener. Range of information that can be exchanged is limited; listener carries burden of communication. Examiner cannot identify materials provided from patient response.", "feedback": "", "rationale": "", "correct": false },
  ...
  },
  {
    ...
    "options": [
      { "text": "0", "description": "Normal.", "feedback": "", "rationale": "<PASTE RATIONALE HERE>", "correct": true },
      { "text": "1", "description": "Mild-to-moderate dysarthria; patietn slurs at least some words and, at worst, can be understood with some difficulty.", "feedback": "", "rationale": "", "correct": false },
      { "text": "2", "description": "Severe dysarthria; patient's speech is so slurred as to be unintelligible in the absence of or out of proportion to any dysphagia, or is mute/anarthric.", "feedback": "", "rationale": "", "correct": false },
  ...
  },
  {
    ...
    "options": [
      ...
      { "text": "2", "description": "Profound hemi-inattention or extinction to more than one modality; does not recovntize own hand or orients to only one side of space.", "feedback": "", "rationale": "", "correct": false }
    ]
  }
];
