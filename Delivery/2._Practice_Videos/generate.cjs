...
// KC video ids keyed by question number
var VIDEO_IDS = {
  1:'1175970664', 2:'1175970729', 3:'1175971157', 4:'1175971255', 5:'1175971360',
  6:'1175972074', 7:'1175972173', 8:'1175972438', 9:'1175972549', 10:'1175972632',
  11:'1175972894', 12:'1175972992', 13:'1175973069'
};
...
<body>
  <div id="videoWrapper" class="video-wrapper" tabindex="-1">
    ...
    <iframe
      id="vimeo"
      tabindex="-1"
      data-standard-id="${VIDEO_IDS[q.n]}"
      data-ead-id="${VIDEO_IDS[q.n]}"
  ...
  <script>
    // Extended Audio Description switch. Reads the Storyline Boolean
    // Extended_Audio_Description_Track. Falls back to the standard video
    // when the variable is missing or Storyline is not present.
    (function () {
      ...
      var params   = f.getAttribute('data-params') ||
        'badge=0&autopause=0&quality_selector=1&progress_bar=1&fullscreen=0';
      var extended = false;
      try {
...
QUESTIONS.forEach(function (q) {
  ...
  // Copy img files (commented out: each Question folder already contains img/)
  // fs.readdirSync(imgSrc).forEach(function (f) {
  //   fs.copyFileSync(path.join(imgSrc, f), path.join(imgDst, f));
  // });

  // Copy styles.css (commented out: each Question folder already contains styles.css)
